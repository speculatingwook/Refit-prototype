...
public class AppleJwtParser {
    ...
    public Map<String, String> parseHeaders(String identityToken) {
        try {
            ...
            throw new TokenValidFailedException("Apple OAuth Identity Token 형식이 올바르지 않습니다.");
        }
    }
    ...
    public Claims parsePublicKeyAndGetClaims(String idToken, PublicKey publicKey) {
        try {
            ...
            throw new TokenValidFailedException("Apple OAuth 로그인 중 Identity Token 유효기간이 만료됐습니다.");
        } catch (UnsupportedJwtException | MalformedJwtException | SignatureException | IllegalArgumentException e) {
            throw new TokenValidFailedException("Apple OAuth Identity Token 값이 올바르지 않습니다.");
        }
    }
}
